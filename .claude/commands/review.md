...
>
> ### Type Safety Check
> For ANY data crossing boundaries (persistence, JSON, external APIs):
> - Verify Codable conformance and decode/encode correctness
> - Check for implicit type coercion
> - Verify optional unwrapping is safe (no force-unwraps without justification)
>
...
> - Are @MainActor annotations correct?
> - Are there data races from concurrent access to mutable state?
> - Are async/await calls properly structured?
>
...
> - "This won't be nil" — What makes you certain?
>
> ### Security & Edge Cases
...
>
> ### UI Convention Compliance (if UI files changed)
> - SwiftUI best practices followed?
> - Accessibility modifiers present?
...
> Review the following files for bugs, type safety issues, concurrency correctness, optional propagation, and security concerns. These files were just modified during an adversarial review cycle — your job is to find anything the prior reviewers missed.
>
> **Files to review:** [list all files modified during the review cycle, plus any files they directly consume or are consumed by]
>
> **Repository context:** Native Apple app (SwiftUI, Swift, local-first). This is Listsurf, a personal structured-list app for iPhone, iPad, and Mac. Focus on SwiftData/GRDB persistence correctness, Swift concurrency (@MainActor, Sendable, data races), optional safety, Codable encode/decode at persistence boundaries, and SwiftUI view lifecycle issues. Read the project's `cs.md` for additional context.
>
...
[grouped by category: return values, type safety, optional handling, concurrency, etc.]
